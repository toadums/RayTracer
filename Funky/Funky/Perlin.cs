...
namespace Funky
{
    class Perlin
    {
        ...
        static public double fade(double t)
        {
        ...
        public double noise(double x, double y, double z)
        {
            ...
            return  lerp(w, lerp(v, lerp(u, gradient(perm[AA], x, y, z),
                    gradient(perm[BA], x - 1, y, z)),
                    lerp(u, gradient(perm[AB], x, y - 1, z),
                    gradient(perm[BB], x - 1, y - 1, z))),
                    lerp(v , lerp(u, gradient(perm[AA + 1], x, y, z - 1),
                    gradient(perm[BA + 1], x - 1, y, z - 1)),
                    lerp(u, gradient(perm[AB + 1], x, y - 1, z - 1),
